...
if(interactive()){
  # sdat_file <- '/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021617_mis-c/results/Dropout_mitigated/PostQC3.RDS'
  # gene_file <- '/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021617_mis-c/genes.xlsx'
  # test_var <- 'Condition'
  # out_pdf <- '/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021617_mis-c/results/RNA_clusters.pdf'
  ...
  name_match_file <- '/hpcdata/vrc/vrc1_data/douek_lab/wakecg/data/Gene_names.RDS'
  test_var <- 'Time,TCR.status'
  out_pdf <- '/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021600_kristin/results/Run2022/Violins.pdf'
} else{
