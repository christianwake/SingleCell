...
out_pdf <- paste0('/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021614_21-002/results/', res_sub, 'Cluster_DE_Comparison.pdf')
...
rds_files <- c(rds_files, '/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021614_21-002/results/Go2/Cluster_DE/One-all/RNA-predicted.celltype.l1.RDS')
rds_files <- rds_files[file.exists(rds_files)]

rna_dats <- lapply(rds_files, function(file) readRDS(file))
names(rna_dats) <- sapply(rds_files, function(file) gsub('/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021614_21-002/results/', '', gsub('/Cluster_DE/One-all/RNA-predicted.celltype.l1.RDS', '', file)))
...
rds_files <- c(rds_files, '/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021614_21-002/results/Go2/Cluster_DE/One-all/prot-predicted.celltype.l1.RDS')
rds_files <- rds_files[file.exists(rds_files)]
prot_dats <- lapply(rds_files, function(file) readRDS(file))
names(prot_dats) <- sapply(rds_files, function(file) gsub('/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021614_21-002/results/', '', gsub('/Cluster_DE/One-all/prot-predicted.celltype.l1.RDS', '', file)))
### Go2 should've been named Downsample_1.0
...
for(celltype in celltypes){
  for(assay in assays){
    ...
    rds_files <- c(rds_files, paste0('/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021614_21-002/results/Go2', later_path))
    rds_files <- rds_files[file.exists(rds_files)]
    de_dats <- lapply(rds_files, function(file) readRDS(file))
    names(de_dats) <- sapply(rds_files, function(file) gsub(paste0('/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021614_21-002/results/', res_sub, '/'), 
