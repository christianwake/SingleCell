...
out_txt <- args[5]
out_pdf <- args[6]
#sdat_file <- '/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021618_galt/results/Clustered.RDS'
#negative_markers <- 'AB-CD3,B-CD3,CD4, CD14'
#positive_markers <- 'CD19,CD20'
#negative_markers <- ''
#positive_markers <- ''
#out_rds <- '/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021618_galt/results//Filtered.RDS'
#out_txt <- '/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021618_galt/results/Filters.txt'
#out_pdf <- '/hpcdata/vrc/vrc1_data/douek_lab/projects/RNASeq/2021618_galt/results/Cluster_filters.pdf'

sdat <- readRDS(sdat_file)

txt <- as.data.frame(matrix(ncol = 2, nrow = 4))
colnames(txt) <- c('filter', 'n')
txt[, 'filter'] <- c('Low expression cluster', 'negative marker cluster', 'positive marker cell', 'remaining')
